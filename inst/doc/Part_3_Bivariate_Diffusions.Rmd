...
Building on the generalized quadratic framework (see the [__DiffusionRgqd__](https://cran.r-project.org/package=DiffusionRgqd) package and related documentation), the template SDE for bivariate jump GQDs is given by the eqns:
\[
\begin{aligned}
